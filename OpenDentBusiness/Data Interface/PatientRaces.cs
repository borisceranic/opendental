...
namespace OpenDentBusiness{
	...
	public class PatientRaces{
		...
		public static void Reconcile(long patNum,List<PatRace> listPatRaces) {
			...
			List<PatientRace> listPatientRacesDB;//Rename this variable and the listPatRaces variable so it is easier to indicate which is the "selected" list and which is the db list.
