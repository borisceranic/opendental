...
namespace OpenDentBusiness {
	...
	public class ConfirmationRequest : TableBase {
		...
		///<summary>Generated by OD.</summary>
		...
		///<summary>Generated by OD. Patient that this request is linked to. No corresponding field in HQ ConfirmationPending.</summary>
		public long PatNum;
		///<summary>Generated by OD. Will be sent back linked to corresponding newly created ConfirmPending. Allows OD proper to link the newly created ConfirmPending to the input ConfirmationRequest and set the short GUID on the appointment.</summary>
		public long ApptNum;
		...
		///<summary>Generated by HQ. Identifies this ConfirmationRequest in future transactions between HQ and OD.</summary>
		...
		[CrudColumn(SpecialType=CrudSpecialColType.DateT)]
		public DateTime DateTimeTransmit;
		...
		///<summary>Generated by OD in some cases and HQ in others. Indicates current status in the lifecycle of this ConfirmationRequest.</summary>
		...
		///<summary>Generated by HQ. FK to SmsToMobile.GuidMessage. Generated at HQ when the confirmation is generated.</summary>
		[CrudColumn(SpecialType=CrudSpecialColType.TextIsClobNote)]
		public string GuidMessageToMobile;
		///<summary>Generated by HQ. FK to SmsFromMobile.GuidMessage. Generated at HQ when the confirmation receives a response.</summary>
		[CrudColumn(SpecialType=CrudSpecialColType.TextIsClobNote)]
