...
namespace OpenDentBusiness {
	...
	public enum XWebTransactionType {
		...
		///<summary>NOT IMPLEMENTED. This transaction removes a Sale, Capture or Return transaction from the current batch. Also, a void can be used on an Authorization transaction to prevent it from being captured in the future. Finally, the Void transaction can be used to reverse the Authorization or Sale transaction, thereby restoring the open-to-buy amount on the consumer card.</summary>
		CreditVoidTransaction,
		///<summary>NOT IMPLEMENTED. This transaction will return the funds to a customer's account after settlement of the original batch has occurred.</summary>
