				...
				if(!PrefC.GetBool(PrefName.EConnectorEnabled)) {
					...
					if(PrefC.GetString(PrefName.WebServiceServerName)=="") {
						...
						if(countCustListeners > 0) {
							...
							MsgBox.Show("PrefL","If you currently use any eServices like the Patient Portal or Integrated Texting, these services will not work correctly until you upgrade your Sistener service to the new eConnector service.  Please call us to help upgrade your eServices.");
						}
					}
