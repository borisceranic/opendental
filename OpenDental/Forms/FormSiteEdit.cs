...
namespace OpenDental {
	...
	public class FormSiteEdit:ODForm {
		...
		private void InitializeComponent()
		{
			...
			this.labelPriProv.TabIndex = 141;
			...
			this.labelAddress2.TabIndex = 135;
			...
			this.labelAddress.TabIndex = 138;
