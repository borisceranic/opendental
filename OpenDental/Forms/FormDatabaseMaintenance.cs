...
//#endif
			...
			Application.DoEvents();
			textLog.Text+=DatabaseMaintenance.MedicationWithInvalidGenericNum(verbose,isCheck);
			Application.DoEvents();
			...
			Application.DoEvents();
			textLog.Text+=DatabaseMaintenance.ScheduleOpsInvalidScheduleNum(verbose,isCheck);
			Application.DoEvents();
