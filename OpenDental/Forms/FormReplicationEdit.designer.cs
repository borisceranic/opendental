namespace OpenDental{
    ...
    "gets changed, be sure to restart the server and each workstation client.";
			...
			this.textRangeStart.TabIndex = 2;
			...
			this.checkUpdateBlocked.TabIndex = 5;
    ...
    "rogram in certain situations.";
			...
			this.textSlaveMonitor.TabIndex = 7;
    ...
    "lication process. This machine should stay on at all times.";
			...
			this.butThisComputer.TabIndex = 8;
			...
			this.checkReportServer.TabIndex = 6;
